...
# **_trouver une phrase d'accrhoche_** 🛰️💫   <br/>
...
- <ins>Moteur</ins> : **SFML 3.0.2** (audio, graphics, window, system, network)

- <ins>IDE</ins> : **Visual Studio** (solution .sln incluse)
...
- **Visual Studio 2022** (ou compatible)
...
Les bibliothèques SFML suivantes sont utilisées :
